...
<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
    <div class="flex justify-between items-center mb-8">
        ...
        <a href="{{ route('hotel-admin.rooms.create') }}" class="bg-ghana-green text-white px-4 py-2 rounded-lg hover:bg-primary-700">Add Room</a>
    </div>
        ...
        @foreach($rooms as $room)
            <div class="bg-white rounded-xl p-6 shadow-sm">
                ...
                <div class="mt-3 space-y-2 text-sm">
                    <div class="flex justify-between"><span class="text-gray-500">Price/Night</span><span class="font-bold text-ghana-green">GHS {{ number_format($room->price_per_night, 2) }}</span></div>
                    ...
                    <div class="flex justify-between"><span class="text-gray-500">Available</span><span class="font-medium {{ $room->available_rooms > 0 ? 'text-ghana-green' : 'text-red-600' }}">{{ $room->available_rooms }}</span></div>
