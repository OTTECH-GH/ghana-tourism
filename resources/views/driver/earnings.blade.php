...
<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-8">
        <div class="bg-white rounded-xl p-6 shadow-sm"><div class="text-sm text-gray-500">Total Earnings</div><div class="text-3xl font-bold text-emerald-600 mt-1">GHS {{ number_format($totalEarnings, 2) }}</div></div>
            ...
            <tbody class="divide-y">
                @foreach($earnings as $e)
                    <tr class="hover:bg-gray-50">
                        ...
                        <td class="px-4 py-3 font-bold text-emerald-600">GHS {{ number_format($e->final_amount - $e->platform_commission, 2) }}</td>
                    </tr>
                @endforeach
            </tbody>
        </table>
